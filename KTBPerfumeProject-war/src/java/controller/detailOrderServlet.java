 ...
 * @author MyPC
 */
@WebServlet(name = "detailOrderServlet", urlPatterns = {"/admin/detailOrderServlet"})
public class detailOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String orCode = request.getParameter("oId");
        Orderinfo oInfo = orderinfoFacade.find(orCode);
        List<Orderdetail> list=orderdetailFacade.searchByInfoOrder(oInfo);
